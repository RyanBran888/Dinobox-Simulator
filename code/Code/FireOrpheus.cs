...
public partial class FireOrpheus : Area2D
{
	...
	public override void _Process(double delta)
	{
		...
		if(Input.IsMouseButtonPressed(MouseButton.Left) && GameManager.TDstamps >= 800)
		{
		...
		}else if(pressed)
		{
			...
			if(collide == false)
			{
				...
				clone.Position = new Vector2(1100, 171);
				GameManager.TDstamps -= 800;
				placed = true;
			}else
			{
				Position = new Vector2(1100, 171);
				collide = true;
			}
			released = true;
